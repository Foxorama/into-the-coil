...
| **the four stages, since 0380** | does the fight read as escalating from a kindled opening, and is the roaming breaker's half-second of spines-in-the-edge enough of a tell to move for? The leap: does the dive out through the edge read as a leap and not a vanish, and does the arrival after it read as the same fight? **Parked, the pulse takes 0.84 hits a second where it took 0.15 before the adds were spat** — pressure or a wall on the second boss of seven |
