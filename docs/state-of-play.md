...
| **a full ladder buys its own face's special; the arsenal is a stack one trigger throws newest-first; the pulse's overdrive and the seeker's hunt are surges, a timed aura that strengthens a weapon** — the second of four; the lightning blast, the whirlpool and the void are next, and a surge's own cue is owed | [0373](decisions/0373-a-special-is-the-guns-own.md) |
