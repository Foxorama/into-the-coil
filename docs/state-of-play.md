...
| **the arc's storm strikes six bodies on the screen, chains twice from each and flickers; the shuriken's whirlpool turns and grows until none of it is on the screen, landing on a boss again and again; the entity ceiling is 614** — the third of four; the shield's void is next, and the specials' own cues are owed | [0374](decisions/0374-the-storm-and-the-whirlpool.md) |
