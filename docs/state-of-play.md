...
| **a death and a continue keep the ladders, the kinds and the charges; the bomb pickup and the clear's charge are gone; a thrown bomb lands a twentieth of a boss; a gun's hit on a boss is weighed by its row and a boss may author its own** — the first of four on one ask; typed specials, their effects and the void are next, in [`the-arsenal-planned`](../reports/the-arsenal-planned-2026-09-26.md) | [0372](decisions/0372-a-death-keeps-the-ladders.md) |
