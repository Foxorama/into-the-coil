...
own, its fan rakes, and its kites dive in from the sides in turn.
...
**The next is the frost ship** — shards that burst into snowflakes that burst again, and adds worth
remembering — then the picture and the music as an album; every one of those is a model quantity
until it is flown.
