...
const DESCENT: readonly WaveEntry[] = [
  ...
  { at: 400, enemy: 'spinner', formation: 'column', count: 3, lane: 30 },
  ...
  { at: 2100, enemy: 'spinner', formation: 'column', count: 3, lane: 35 },
...
const COILWARD: readonly WaveEntry[] = [
  ...
  { at: 1864, enemy: 'sower', formation: 'column', count: 5, lane: 44 },
  ...
  { at: 2692, enemy: 'sower', formation: 'vee', count: 4, lane: 44 },
...
const SHOAL: readonly WaveEntry[] = [
  ...
  { at: 1830, enemy: 'sower', formation: 'column', count: 5, lane: 56, origin: 'acrossPlus' },
...
const BATTERIES: readonly WaveEntry[] = [
  ...
  { at: 480, enemy: 'spinner', formation: 'line', count: 4, lane: 42 },
  ...
  { at: 1560, enemy: 'spinner', formation: 'column', count: 4, lane: 59 },
...
const GAUNTLET: readonly WaveEntry[] = [
  ...
  { at: 385, enemy: 'sower', formation: 'line', count: 5, lane: 44 },
  ...
  { at: 2085, enemy: 'spinner', formation: 'line', count: 5, lane: 44 },
...
const EYE: readonly WaveEntry[] = [
  ...
  { at: 464, enemy: 'spinner', formation: 'line', count: 5, lane: 42, origin: 'acrossMinus' },
  { at: 546, enemy: 'sower', formation: 'line', count: 5, lane: 53 },
  ...
  { at: 1448, enemy: 'sower', formation: 'line', count: 5, lane: 44, origin: 'acrossPlus' },
  ...
  { at: 2432, enemy: 'spinner', formation: 'vee', count: 6, lane: 58, origin: 'acrossMinus' },
