...
| release type | Album — eight tracks, 19:16 |
...
| loudness | every track −14.0 LUFS integrated, true peak −1.7 dBTP or lower (Saurian Belt −3.3) — the level Spotify plays at, so nothing is turned down or squashed on the way out |

## The tracks

| # | title | file | length | what it is |
|---|---|---|---|---|
| 1 | Into the Coil | `01 Into the Coil.wav` | 2:05 | The title screen's groove grown into a piece: the drone wakes, the riff and the kit arrive, a lead states the game's theme, a flute breakdown, everything back, and an ending. |
| 2 | The Approach | `02 The Approach.wav` | 2:24 | Level one: the base composition the whole game grows out of, its climb to the first fight, and a coda. |
| 3 | Ember Nebula | `03 Ember Nebula.wav` | 2:25 | A cathedral in a furnace — choir and organ first, the fire under them after, the organ's three high notes bouncing between the ears. |
| 4 | Saurian Belt | `04 Saurian Belt.wav` | 2:24 | The floor-filler: a kit that leads, a supersaw riff, a raptor's call, tom fills that cascade from the left ear to the right. |
| 5 | The Labyrinth | `05 The Labyrinth.wav` | 2:22 | A corridor, and something breathing in it — footsteps, a limping spiral, a pursuit. |
| 6 | Rime Shelf | `06 Rime Shelf.wav` | 2:22 | Glass that rings and cracks, and the weather coming in over it. |
| 7 | The Toxic Mire | `07 The Toxic Mire.wav` | 2:25 | Still water with something under it. |
| 8 | The Black Heart | `08 The Black Heart.wav` | 2:29 | Four movements under one heartbeat that quickens: a piano and flute lament, the same song faster, an orchestral ballad that climbs to its summit and walks back down, and a sombre acceptance into the last fight. |
...
then **a coda**: four bars, struck on the next downbeat, in the place's own instruments (its pad, drone, lowest
note, lead and kit; The Black Heart's heart beats twice more). No sound effect, gun, death or cue is in any file.
...
```bash
node scripts/hear.mjs --level=approach --album --cold --out=C:/itc-renders/album-draft2/t.wav
node scripts/album.mjs --title --out=C:/itc-renders/album-draft2/t-album-title.wav
npx vite build
