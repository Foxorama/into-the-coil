  ...
  },
  {
    ...
    */
    ...
    edit: {
      ...
      replace: "  boss: { drone: 0.42, bass: 0, beat: 0, sub: 1.05, engine: 0.72, perc: 0.6, chords: 0, groove: 0, arp: 0, ride: 0.5, call: 0, hook: 0, drive: 0.5, toll: 0.9, crash: 0.66, dread: 1, lead: 0, stomp: 0.5, frenzy: 0.45, wraith: 0, auraSlow: 0, auraFast: 0 },",
    },
  },
  {
    decision: '0091',
