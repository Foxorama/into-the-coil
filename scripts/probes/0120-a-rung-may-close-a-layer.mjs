  ...
  },
  {
    ...
    */
    ...
    edit: {
      ...
      replace:
        "  surge: { drone: 0.33, bass: 0, beat: 0, sub: 1.04, engine: 1, perc: 0.82, chords: 0.86, groove: 0.94, arp: 0.7, ride: 0.68, call: 0, hook: 0.74, drive: 0, toll: 0, crash: 0, dread: 0, lead: 0.78, counter: 0, stomp: 0, frenzy: 0, wraith: 0, auraSlow: 0.75, auraFast: 0.55, ownA: 0, ownB: 0, ownC: 0, ownD: 0 },",
    },
  },
];
