...
export const PROBES = [
  ...
  },
  {
    ...
    edit: {
      ...
      // ⚠️ Re-anchored by 0262, which said where a summons comes from, by 0263, which sent the
      // shards in from the sides, and by 0270, which said how many of them may stand.
      find: "attack: { kind: 'summon', enemy: 'shard', count: 2, formation: 'vee', from: 'sides', standing: 6 } },",
      replace: "attack: { kind: 'summon', enemy: 'raptor', count: 2, formation: 'vee', from: 'sides', standing: 6 } },",
    },
  },
  {
    decision: '0253',
