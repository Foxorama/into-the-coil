...
export const PROBES = [
  ...
  },
  {
    ...
    */
    ...
    edit: {
      path: 'src/content/music.ts',
      find: '  run: { drone: 0.34, bass: 0, beat: 0, sub: 0.86, engine: 0.9, perc: 0.66, chords: 0.86, groove: 0.8, arp: 0, ride: 0, call: 0.62, hook: 0, drive: 0, toll: 0, crash: 0, dread: 0, lead: 0, stomp: 0, frenzy: 0, wraith: 0, auraSlow: 0.5, auraFast: 0.28 },',
      replace: '  run: { drone: 0.34, bass: 0, beat: 0, sub: 0.86, engine: 0.9, perc: 0.66, chords: 0.86, groove: 0, arp: 0, ride: 0, call: 0.62, hook: 0, drive: 0, toll: 0, crash: 0, dread: 0, lead: 0, stomp: 0, frenzy: 0, wraith: 0, auraSlow: 0.5, auraFast: 0.28 },',
    },
  },
  {
    decision: '0104',
    ...
    edit: {
      path: 'src/content/music.ts',
      find: '  surge: { drone: 0.33, bass: 0, beat: 0, sub: 1.02, engine: 0.98, perc: 0.82, chords: 0.88, groove: 0.92, arp: 0.68, ride: 0.66, call: 0.74, hook: 0.72, drive: 0.7, toll: 0, crash: 0.78, dread: 0, lead: 0.74, stomp: 0, frenzy: 0, wraith: 0, auraSlow: 0.75, auraFast: 0.55 },',
      /*
      ...
      */
      replace: '  surge: { drone: 0.33, bass: 0, beat: 0, sub: 1.02, engine: 0.98, perc: 0.82, chords: 0.88, groove: 0.92, arp: 0.68, ride: 0.66, call: 0.74, hook: 0, drive: 0.7, toll: 0, crash: 0.78, dread: 0, lead: 0, stomp: 0, frenzy: 0, wraith: 0, auraSlow: 0.75, auraFast: 0.55 },',
    },
  },
];
